...
public class DomWriteKLNSPG
{
    ...
    public static void main(String[] args)
    {
        try
        {
            File inputFile = new File("C:\Users\buha3\Desktop\KLNSPG_1108\IY5AM2_kurzusfelvetel.xml");
            ...
            writeDocumentToFile(doc, "C:\Users\buha3\Desktop\KLNSPG_1108\IY5AM2_kurzusfelvetel_1.xml");
            
            System.out.println("The content has been written to IY5AM2_kurzusfelvetel_1.xml successfully.");
        }
        catch (Exception e)
        {
            e.printStackTrace();
