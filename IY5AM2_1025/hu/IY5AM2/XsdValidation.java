...
public class XsdValidation {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 2) 
        {
            xmlPath = "C:\Users\buha3\Desktop\KLNSPG_1025\hu\IY5AM2\IY5AM2_kurzusfelvetel.xml";
            xsdPath = "C:\Users\buha3\Desktop\KLNSPG_1025\hu\IY5AM2\IY5AM2_kurzusfelvetel.xsd";
        } 
        else
        {
            xmlPath = args[0];
