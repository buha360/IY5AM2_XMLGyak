...
public class xPathModify {
    ...
    public static void main(String[] args) {
        try {
            ...
            File inputFile = new File("C:\Users\buha3\Desktop\KLNSPG_1122\IY5AM2_kurzusfelvetel.xml");
            ...
            saveToFile(doc, "KLNSPG_kurzusfelvetel1.xml");
    ...
    private static void addNewCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Element kurzusokElement = (Element) xPath.compile("/IY5AM2_kurzusfelvetel/kurzusok").evaluate(doc, XPathConstants.NODE);
    ...
    private static void deleteCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Node courseToDelete = (Node) xPath.compile("/IY5AM2_kurzusfelvetel/kurzusok/kurzus[@id='GEIAL120-B']").evaluate(doc, XPathConstants.NODE);
    ...
    private static void modifyCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Node courseToModify = (Node) xPath.compile("/IY5AM2_kurzusfelvetel/kurzusok/kurzus[@id='GEMAK234-B']").evaluate(doc, XPathConstants.NODE);
